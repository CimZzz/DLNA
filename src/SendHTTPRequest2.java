...
public class SendHTTPRequest2 {
    public static void main(String[] args) throws Exception{
        ...
        outputStream.writeBytes("SOAPACTION: \"urn:upnp-org:serviceId:AVTransport#Play\"\r\n");
        outputStream.writeBytes("Content-Length: 376\r\n");
        outputStream.writeBytes("\r\n");

        File file = new File("/Users/xjw04/Desktop/play.xml");
