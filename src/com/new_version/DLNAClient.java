...
public class DLNAClient {
    ...
    public void startDLNA() {
        synchronized (this) {
            ...
            dlnaContext = new DLNAContext(this,useDebugMode);
    ...
    //搜索设备方法
    public void search(String deviceType) {
        synchronized (this) {
            if(state < STATE_START_COMPLETED)
                return;
        }
    ...
    //取消订阅服务
    public void cancelSubscribe(Service service) {
        synchronized (this) {
            if(state < STATE_START_COMPLETED)
                return;
        }
    ...
    public static class Builder {
        ...
        public Builder useDebugMode(boolean useDebugMode) {
            client.useDebugMode = useDebugMode;
            return this;
        }
