...
import com.new_version.factory.ThreadPoolFactory;
...
import static com.new_version.constant.ErrorCode.SERVER_INFO_FAILED;
...
public class DLNAContext {
    ...
    ConcurrentHashMap<Integer,Instance> instancePool;//实例池
...
//                }
    ...
    void executeCommand(Service service,SoapCommand soapCommand) {
        execute(new Runnable() {
            @Override
            public void run() {
                ...
                try {
                    ...
                    if(httpHeader.methodPath.equals("200"))
                        System.out.println(soapCommand + " Command Success");
    ...
    void findServiceInfo(Service service) {
        execute(new Runnable() {
            @Override
            public void run() {
                ...
                try {
                    ...
                    if(!XMLAnalyzer.analyzeSDD(service,boundedInputStream))
    ...
    void subscribe(Service service) {
        ...
        try {
            ...
            if(httpHeader.methodPath.equals("200")) {
                ...
                } else subscribeEvent.actionId = com.SubscribeEvent.ACTION_SUBSCRIBE_FAILED;
            } else
    ...
    private void renewSubscribe(Service service) {
        ...
        try {
            ...
            if(httpHeader.methodPath.equals("200")) {
                ...
                } else subscribeEvent.actionId = com.SubscribeEvent.ACTION_RENEW_SUBSCRIBE_FAILED;
            } else
